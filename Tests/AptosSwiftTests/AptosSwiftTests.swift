    ...
    func testTransactionExamples() throws {
        ...
        DispatchQueue.global().async {
            do {
                ...
                let transaction = AptosRawTransaction(sender: try AptosAddress("0x689b6d1d3e54ebb582bef82be2e6781cccda150a6681227b4b0e43ab754834e5"), sequenceNumber: UInt64(acountsequence.sequenceNumber)!, maxGasAmount: 1000, gasUnitPrice: 1, expirationTimestampSecs: date, chainId: 23, payload: AptosTransactionPayload.ScriptFunction(payloadscriptfunction))
