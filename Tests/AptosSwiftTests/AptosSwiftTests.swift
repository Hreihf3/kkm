    ...
    func testTransactionExamples() throws {
        ...
        DispatchQueue.global().async {
            do {
                ...
                let transaction = AptosRawTransaction(sender: try AptosAddress("0x689b6d1d3e54ebb582bef82be2e6781cccda150a6681227b4b0e43ab754834e5"), sequenceNumber: 6, maxGasAmount: 1000, gasUnitPrice: 1, expirationTimestampSecs: data, chainId: 22, payload: AptosTransactionPayload.ScriptFunction(payloadscriptfunction))
